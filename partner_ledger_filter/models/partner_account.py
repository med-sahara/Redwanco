...
class AccountReport(models.AbstractModel):
    ...
    _description = 'Inherit account report model'
    ...
    def _set_context(self, options):
        ...
        """This method will set information inside the context based on the options
        dict as some options need to be in context for the query_get method defined in account_move_line"""
...
class AccountMoveLineInherit(models.AbstractModel):
    ...
    _description = 'Inherit account.move.line model for account filter'
    ...
    def _query_get(self, domain=None):
        ...
        res = super(AccountMoveLineInherit, self)._query_get(domain)
        return res
