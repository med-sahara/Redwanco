odoo.define('account_operating_unit.account_report', function (require) {
'use strict';
...
//            self.$searchview_buttons.find('[data-filter="operational_unit"]').select2("val", self.report_options.operational_unit);
        }
...
//            self.report_options.operational_unit = self.$searchview_buttons.find('[data-filter="operational_unit"]').val();
            return self.reload().then(function(){
...
//                if ('operating_unit_id' in this.report_options) {
//                        fields['operating_unit_id'] = {
//                            label: _t('Operating Unit'),
//                            modelName: 'operating.unit',
//                            value: this.report_options.operating_unit_id.map(Number),
//                        };
//                    }
                if (!_.isEmpty(fields)) {
